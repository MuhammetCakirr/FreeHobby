...
class UserService {
  ...
  void addHobbiesAndCategories() async {
    ...
    //});
    //// -----
    //await _firestore.collection('category').doc('16').set({
    //  'name': 'Satranç',
    //  'categoryId': 4,
    //});
    //await _firestore.collection('category').doc('17').set({
    //  'name': 'Tavla',
    //  'categoryId': 4,
    //});
    //await _firestore.collection('category').doc('18').set({
    //  'name': 'Dama',
    //  'categoryId': 4,
    //});
    //await _firestore.collection('category').doc('19').set({
    //  'name': 'Okey',
    //  'categoryId': 4,
    //});
    //await _firestore.collection('category').doc('20').set({
    //  'name': 'Mangala',
    //  'categoryId': 4,
    //});
    //
